...
train_imgs = torch.FloatTensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/training.npy").reshape([-1, 3, 24, 24]))
train_labels = torch.tensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/training-labels.npy").repeat(45))
val_imgs = torch.FloatTensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/validation.npy").reshape([-1, 3, 24, 24]))
val_labels = torch.tensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/validation-labels.npy").repeat(45))
test_imgs = torch.FloatTensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/test.npy").reshape([-1, 3, 24, 24]))
test_labels = torch.tensor(np.load("/home/cddt/data-space/COMPSCI760/cacophony-preprocessed/test-labels.npy").repeat(45))
