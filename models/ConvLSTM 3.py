...
model = Sequential()
model.add(ConvLSTM2D(24, (3,3), data_format = "channels_first", input_shape = (45,3,24,24), return_sequences = True))
model.add(Dropout(0.6))
model.add(ConvLSTM2D(24, (3,3), data_format = "channels_first", input_shape = (45,3,24,24), return_sequences = False))
model.add(Dropout(0.6))
model.add(Flatten())
